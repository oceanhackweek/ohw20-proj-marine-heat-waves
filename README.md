...
Current or new [issues can be found here](https://github.com/oceanhackweek/ohw20-proj-marine-heat-waves/issues). 

# Current status


The Jupyter notebook  Test_Run_Timeseries.ipynb integrates our efforts at the end of Ocean Hack Week 2020.
